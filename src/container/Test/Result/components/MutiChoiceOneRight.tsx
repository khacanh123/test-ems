...
const MuitichoiceOneRight = (props: any) => {
                ...
                if (!chk) {
                  ...
                  if (check == 2) {
                    return (
                      <div
                        key={index}
                        className=' rounded-3xl flex items-center px-2 py-2 cursor-pointer text-black border border-ct-green-300'
                      >
                        <p className='font-bold pr-2'>{alphabe[index]}:</p>
                    ...
                    return (
                      <div
                        key={index}
                        className=' rounded-3xl flex items-center px-2 py-2 cursor-pointer text-black border border-ct-red-300'
                      >
                        <p className='font-bold pr-2'>{alphabe[index]}:</p>
...
export default MuitichoiceOneRight;
